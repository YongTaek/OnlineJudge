        ...
        content: contents {
            ...
            div() {
                ...
                div(class: 'prob-container') {
                    form(id : 'write_question', action:'/question/answermodify/'+messages.id, method:'post') {
                        div(class: 'col-md-12') {
                            span '답변 제목'
                        ...
                        div(class: 'col-md-12') {
                            input(type: 'text', value: messages.contents, name: 'answer_contents', size : '40', style : "height : 100px;, id : 'content")
                        }
                        div(class: 'col-md-12') {
                            div(class: 'row') {
